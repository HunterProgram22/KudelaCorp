"""
Django settings for KudelaCorp project.
...
SECRET_KEY = '1=)v6iz1n)w2@r(oko-r6%pzqp_o)*knpi5+c8q#5%-cu9=l&v'
...
ROOT_URLCONF = 'KudelaCorp.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['KudelaCorp/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'KudelaCorp.wsgi.application'
